...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Eshaan Bajpai</title>
            <meta name="description" content="Explore articles authored by Eshaan Bajpai, a Full Stack Engineer and Developer." />
