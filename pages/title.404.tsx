...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Eshaan Bajpai</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Eshaan Bajpai, Portfolio,broken link ,missing page,link not found" />
