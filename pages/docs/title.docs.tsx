...
export default function TitleDocs() {
    return (
        <Head>
            ...
            <meta name="description" content="Explore a collection of documentation for my Open Source projects authored by Eshaan Bajpai, covering various technology topics." />
