...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Eshaan Bajpai</title>
            ...
            <meta name="keywords" content="500, internal server error, Eshaan Bajpai, Portfolio,broken link ,missing page,link not found" />
